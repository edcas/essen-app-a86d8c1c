...
const HomeScreen = () => {
  const pendingItems = [
    { icon: FileText, label: "Documentos pendientes", count: 3, color: "bg-accent text-accent-foreground" },
    { icon: ClipboardCheck, label: "Evaluaciones por contestar", count: 1, color: "bg-accent text-accent-foreground" },
    { icon: GraduationCap, label: "Cursos por completar", count: 2, color: "bg-accent text-accent-foreground" },
  ];
  ...
  return (
    <div className="px-5 py-4 space-y-6 animate-fade-in">
      ...
      <div className="bg-primary rounded-2xl p-5 text-primary-foreground">
        <h2 className="text-lg font-bold">¡Buen día, Carlos!</h2>
